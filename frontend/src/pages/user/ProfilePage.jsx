                      ...
                      <div className="h-36 overflow-hidden relative">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            e.target.parentElement.style.background = 'rgba(30,41,59,0.8)';
                            e.target.parentElement.innerHTML = '<div style="display:flex;align-items:center;justify-content:center;height:100%;font-size:2.5rem">📸</div>';
                          }}
                        />
                        <div
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          {report.status === 'cleared' && (
                            <span className="text-green-400 text-xs font-bold">+10 pts earned</span>
                          )}
                        </div>
                      </div>
                    </div>
            ...
            {notifLoading ? (
              ...
              notifications.map((notif) => (
                <div
                  ...
                  style={{
                    background: notif.read ? 'rgba(15,23,42,0.8)' : 'rgba(249,115,22,0.08)',
                    border: notif.read ? '1px solid rgba(100,116,139,0.2)' : '1px solid rgba(249,115,22,0.3)',
                  }}
                  onClick={() => !notif.read && markAsRead(notif._id)}
                >
                  <div className="text-2xl flex-shrink-0">
                    {notif.type === 'report_cleared' ? '✅' :
                     notif.type === 'report_assigned' ? '👷' :
                     notif.type === 'points_earned' ? '⭐' : '🔔'}
                  </div>
                  <div className="flex-1">
                    <p className={`text-sm ${notif.read ? 'text-slate-400' : 'text-white font-medium'}`}>
                      {notif.message}
                    </p>
                  ...
                  {!notif.read && (
                    <div className="w-2 h-2 rounded-full bg-orange-400 flex-shrink-0 mt-1"></div>
                  )}
                </div>
              ))
            )}
